...
import 'package:app/provider/provider_login.dart';
...
class LoginPart extends ConsumerWidget {
            ...
            child: Column(
              children: [
                ...
                customTextField(
                  ...
                  onChanged: (text) {
                    ref.read(loginNotifierProvider.notifier).mapEventsToState(LoginPasswordlChanged(text: controllerPassword.value.text),);
                  },
                ),
                Row(
                  children: [
